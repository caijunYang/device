...
/**
 * @Description：正则表达式用具类<br>
 * @author：xxq<br>
 * @date：2017年8月7日<br>
 */

/**
 * @Description：RegexUtils<br>
 * @author：xxq<br>
 * @date：2017年8月7日<br>
 */
public class RegexUtils {
	 ...
	 * 小数位数正则
	 */
	public static final String DECIMAL = "^(-)?(([1-9]{1}\\d*)|([0]{1}))(\\.(\\d){%s})?$";
	/**
	 * 手机号码正则
	 */
	public static final String PHONENUMBER = "^1[3|4|5|8][0-9]\\d{8}$";
	/**
	 * 特殊字符正则
	 */
	public static final String SPECIALCHAR = "[a-z]*[A-Z]*\\d*-*_*\\s*";
	...
	public static boolean isDecimal(String decimal, int count) {
		if (null == decimal || "".equals(decimal))
			return false;
		String regex = String.format(DECIMAL, count);
	...
	public static boolean hasSpecialChar(String text) {
		if (null == text || "".equals(text))
			return false;
		if (text.replaceAll(SPECIALCHAR, "").length() == 0) {
			// 如果不包含特殊字符
			return true;
		}
		return false;
